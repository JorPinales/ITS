    ...
    class PDF extends FPDF
    {
        ...
        function LoadData(){    	
            ...
            while ($registro = mysqli_fetch_array($tablaBD)) {
                $data[] = array($registro['claveEmpleado'],$registro['nombre'],$registro['apPaterno'],$registro['apMaterno'],$registro['cursoImpartido'],$registro['cursoNombre']);                 
            } 
			return $data;                                                                              
    	}
        ...
        function Header(){           
            ...
            $this->Cell(0,60,'REPORTE DE PROFESORES',0,0,'C');                                    
        }
...
$data = $pdf->LoadData();
$pdf->AddPage();
$pdf->SetTitle('REPORTE PROFESORES');
// Column headings
$header  = array('Clave','Nombre','Apellido Paterno','Apellido Materno','Clave Curso','Curso Nombre');    
$pdf->AliasNbPages();
