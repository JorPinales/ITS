    ...
    class PDF extends FPDF
    {
        ...
        function LoadData(){    	
            ...
            while ($registro = mysqli_fetch_array($tablaBD)) {
                $data[] = array($registro['matricula'],$registro['nombre'],$registro['apPaterno'],$registro['apMaterno'],$registro['especialidad'],$registro['cursoNombre'],$registro['estado']);                 
            } 
			return $data;                                                                              
    	}
        ...
        function Header(){           
            ...
            $this->Cell(0,60,'REPORTE DE ALUMNOS',0,0,'C');                                    
        }
        ...
        function FancyTable($header, $data){    
            ...
            {                   
                ...
                $this->Cell($w[6],4,$row[6],1,0,'C',false);                                                                
                $this->Ln(4);
                $this->SetX(5);
...
// Column headings
$header  = array('Matricula','Nombre','Apellido Paterno','Apellido Materno','especialidad','Curso Nombre','Estado');    
$pdf->AliasNbPages();
