...
<form id='frmAddAlumnosProf' action='./qryAlumnosProf.php' method='POST'>
    ...
    <tr height="50px">
        <td align='center'>
            <input type='button' id='btnGrabar' name='btnGrabar' value='Grabar' style='width: 100px' onClick='grabarAlumnosProf()'>
        </td>
        <td colspan='2' align='center'>
            <input type='button' id='btnRegresar' name='btnRegresa' value='Regresar' style='width: 100px' onClick='regresarShwAlumnosProf()'>            
        </td>
    </tr>
    </table>
</form>
