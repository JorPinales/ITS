<?php
    ...
    $strQry = "SELECT * FROM alumnos WHERE cursoNombre = 'Judo' ORDER BY nombre";
    ...
    if (mysqli_num_rows($tablaBD)>0){       
        ...
        <form id='frmUpdAlumnosProf' action='../alumnos/updAlumnosProf.php' method='POST'>        
        ...
        <table align='center' width='700' border='0'>
            <tr><td colspan='2' align='center'>
                ...
                onclick='buscarAlumnosProf()'>

                <!-- botón de imprimir -->
                <input type='button' id='btnPrint' name='btnPrint' value='Imprimir' 
                onclick='imprimirAlumnosProf()'>

                <!-- botón de agregar -->
                <input type='button' id='btnAgregar' name='btnAgregar' value='Agregar' 
                onclick='agregarAlumnosProf()'> 

                <input type='button' id='btnGenerarJSON' name='btnGenerarJSON' value='Guardar Alumnos Aprobados' 
                onclick="location.href = 'http://localhost/aeits/json/writeJSON.php' "> 
        ...
        <table align='center' border='1' width='1000'>            
            ...
            while ($registro = mysqli_fetch_array($tablaBD)) {
                ...
                echo "<tr
                        ...
                        onClick=\"actualizarAlumnosProf('$id','$matricula', '$nombre', '$apPaterno', '$apMaterno','$email','$especialidad','$cursoNombre','$estado')\";>
