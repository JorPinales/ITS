...
<form id='frmUpdAlumnos' action='qryAlumnos.php' method='POST'>
    ...
    <table align='center' width='400'>
        ...
        <tr height='100'>
            <td colspan='2' align='center'>
                <table border='1'>
                <tr>
                <td><input type='button' id='btnGrabar' name='btnGrabar' value='Grabar' style='width: 100px' onClick='enviarAlumnos("upd")'></td>
                <td><input type='button' id='btnEliminar' name='btnEliminar' value='Eliminar' style='width: 100px' onClick='enviarAlumnos("del")'></td>
                <td><input type='button' id='btnRegresar' name='btnRegresar' value='Regresar' style='width: 100px' onClick='enviarAlumnos("back")'></td>
                </tr>
            </td>
        </tr>
    </table>
